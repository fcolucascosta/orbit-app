...
- [ ] **B07** - Toast notifications: Feedback visual para ações (criado, editado, deletado, erro)
...
### Estrutura do Banco para Archive
```sql
ALTER TABLE habits ADD COLUMN archived BOOLEAN DEFAULT false;
ALTER TABLE habits ADD COLUMN archived_at TIMESTAMP WITH TIME ZONE;
```

### Ordem sugerida de implementação
1. B01-B02 (Arquivar) - Feature mais pedida
2. B04, B07 (Erros e feedback) - Estabilidade
3. B03, P01 (Animações) - Polish
